...
<body class="scroll">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="registro.php"><button type="button" class="btn btn-warning">Registrar</button></a>
            <a href="ingreso.php"><button type="button" class="btn btn-light">Ingresar</button></a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        <img src="img/oximetro.png" class="card-img-top" alt="...">
                                        <div class="card-body">
    ...
    <section class="team contenedor" id="equipo">
        ...
        <div class="tarjetas">
            <div class="card" style="width: 18rem;">
                <img src="img/presentacion1.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
